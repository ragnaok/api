...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateBikeRequestBody();
  });
  ...
  describe('CreateBikeRequestBody', function() {
    it('should create an instance of CreateBikeRequestBody', function() {
      // uncomment below and update the code to test CreateBikeRequestBody
      //var instance = new Api.CreateBikeRequestBody();
      //expect(instance).to.be.a(Api.CreateBikeRequestBody);
    });
