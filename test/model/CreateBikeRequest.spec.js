...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.CreateBikeRequest();
  });
  ...
  describe('CreateBikeRequest', function() {
    it('should create an instance of CreateBikeRequest', function() {
      // uncomment below and update the code to test CreateBikeRequest
      //var instance = new Api.CreateBikeRequest();
      //expect(instance).to.be.a(Api.CreateBikeRequest);
    });
