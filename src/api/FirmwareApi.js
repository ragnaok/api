...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/QueryFirmwareResponseBody'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/QueryFirmwareResponseBody'));
  } else {
    // Browser globals (root is window)
    if (!root.Api) {
      root.Api = {};
    }
    root.Api.FirmwareApi = factory(root.Api.ApiClient, root.Api.QueryFirmwareResponseBody);
  }
}(this, function(ApiClient, QueryFirmwareResponseBody) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/QueryFirmwareResponseBody} data The data returned by the service call.
     ...
     * data is of type: {@link module:model/QueryFirmwareResponseBody}
     */
    this.queryFirmwareList = function(version, partNum, fwVer, callback) {
      ...
      var returnType = QueryFirmwareResponseBody;
