...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateBikeRequest', 'model/CreateBikeResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateBikeRequest'), require('../model/CreateBikeResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Api) {
      root.Api = {};
    }
    root.Api.BikeApi = factory(root.Api.ApiClient, root.Api.CreateBikeRequest, root.Api.CreateBikeResponse);
  }
}(this, function(ApiClient, CreateBikeRequest, CreateBikeResponse) {
  'use strict';
